...
cp "$vocab" ~/.minutes/models/parakeet/tdt-600m/tdt-600m.tokenizer.vocab
...
cp "$vocab" ~/.minutes/models/parakeet/tdt-ctc-110m/tdt-ctc-110m.tokenizer.vocab
# GNU tar (Linux):
#   tar xf parakeet-tdt_ctc-110m.nemo --wildcards --no-anchored '*tokenizer.vocab'

# Clean up .nemo file
rm parakeet-tdt_ctc-110m.nemo
```
